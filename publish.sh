...
echo "###############################################################"
    ...
    ./copyfile.sh $MODULE/target/$MODULE-0.0.1-SNAPSHOT.jar /jbh/servers/data/$MODULE.jar
    ./copyfile.sh $MODULE/src/main/resources/$PROPERTIES_FILE.properties /jbh/servers/data/$MODULE.properties
